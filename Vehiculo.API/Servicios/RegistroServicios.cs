...
using Abstracciones.Modelos.Servicios.Rrgistro;
...

{
    ...
    public class RegistroServicios : IRegistroServicio
    {
        private readonly IConfiguracion _configuracion;
        private readonly IHttpClientFactory _httpClient;

        public RegistroServicios(IConfiguracion configuracion, IHttpClientFactory httpClient)
        {
